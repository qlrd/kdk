...
//! # Security notice
//!
//! > A bug in this crate — a missed `Drop`, a leaky `Debug`, a copy that
//! > escapes the wipe — silently breaks the amnesia guarantee across
...
pub use sensitive::{wipe_in_place_mut, Sensitive, SensitiveBytes, SensitiveMut};

pub mod prelude {
    pub use crate::{Sensitive, SensitiveBytes, SensitiveMut};
}
